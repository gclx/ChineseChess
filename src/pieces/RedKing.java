 ...
 * @author gclx
 * @version 1.0
 * @date 2018年11月15日 下午15:36:38
 * @copyright 
 * @remarks TODO
 *
 */
public class RedKing extends ChessPieces{
	 ...
	 * @param name
	 */
	public RedKing(int x, int y, boolean isalive, boolean isred, String name) {
...
//		System.out.println("toY: " + toY);
		...
		if (toX < 7 || toY > 5 || toY < 3)	return false;
